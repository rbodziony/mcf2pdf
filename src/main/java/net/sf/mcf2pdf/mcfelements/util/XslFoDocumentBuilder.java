...
/**
 * A builder for XSL-FO documents. This builder provides a simple way to build a
 * flow of pages, and internally maintains a DOM with the according XSL-FO
 * elements. When finished with adding content, call
 * <code>createDocument()</code> to receive the DOM object.
 */
