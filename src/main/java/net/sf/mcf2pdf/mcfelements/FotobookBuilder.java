...
public final class FotobookBuilder {
	 ...
	 * 
	 * @param configurator
	 *            Configurator to use to configure the internal Digester object.
	 */
	...
	/**
	 * Reads the given MCF input file and creates an MCF DOM reflecting the relevant
	 ...
	 * @throws SAXException
	 *             If any XML related problem occurs reading the file.
	 */
